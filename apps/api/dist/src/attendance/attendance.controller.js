...
let AttendanceController = class AttendanceController {
    ...
    findAllByBranch(branchId, startDate, endDate) {
        return this.attendanceService.findAllByBranch(branchId, startDate, endDate);
    }
};
exports.AttendanceController = AttendanceController;
__decorate([
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'PASTOR', 'DEPARTMENT_LEADER', 'USHER'),
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AttendanceController.prototype, "findAllByBranch", null);
